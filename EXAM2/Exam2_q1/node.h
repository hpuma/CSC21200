...
//
//   template <class Item>
//   void print_list(node<Item>* head_ptr);
//     Postcondition: Print out the node's data.
//
...
void list_head_insert(node<Item>*& head_ptr, const Item2& entry);
...
void list_insert(node<Item>* previous_ptr, const Item& entry);
template <class Item, class Item2>
void list_insert(node<Item>* previous_ptr, const Item2& entry);
